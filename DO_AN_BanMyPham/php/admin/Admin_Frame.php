<div class="sidebar">
    ...
    <div class="sidemenu">
        ...
        <div class="list-function">
            <ul>
                <li>
                    <div class="function-menu not-menu active" onclick="loadPageByAjax('Admin_Home'), selectMenu(this)">
                        <span><i class="fa-thin fa-house"></i> Trang Chủ</span>
                    </div>
                </li>
                <li>
                    <div class="menu-wrapper">
                        <div class="function-menu dropdown-select" onclick="selectMenu(this), changeIconArrowSidebar(this)">
                ...
                <li>
                    <div class="function-menu not-menu" onclick="loadPageByAjax('Admin_Discount'), selectMenu(this)">
                        <span><i class="fa-thin fa-badge-percent"></i> Khuyến Mại</span>
                    </div>
                </li>
                <li>
                    <div class="function-menu not-menu" onclick="loadPageByAjax('Admin_Statistic'), selectMenu(this)">
                        <span><i class="fa-thin fa-signal-bars"></i> Thống Kê</span>
                    </div>
                </li>
                <li>
                    <div class="function-menu not-menu" onclick="loadPageByAjax('Admin_Display'), selectMenu(this)">
